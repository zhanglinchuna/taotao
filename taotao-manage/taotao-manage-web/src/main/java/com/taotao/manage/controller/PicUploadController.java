...
public class PicUploadController {
     ...
     * @throws Exception
     */
    // produces指定响应给页面的content-type类型为text
    @RequestMapping(value = "/upload", method = RequestMethod.POST, produces = MediaType.TEXT_PLAIN_VALUE/*produces指定响应给页面的content-type类型为text*/)
    @ResponseBody
